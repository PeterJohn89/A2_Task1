...
<div id="loader" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-90 text-white z-50 hidden">
    <div role="status" class="flex flex-col items-center p-10">
        ...
        <h2 class="mt-4 text-4xl">Please wait while we load your music</h2>
        <p class="mt-4 text-2xl">This may take a few minutes</p>
